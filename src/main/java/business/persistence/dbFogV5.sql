...
INSERT INTO `order` VALUES (1,1,134,55),(2,1,200,99),(3,1,880,550),(4,1,890,560),(5,1,999,1020),(6,1,999,750),(7,1,550,660),(8,1,880,990),(9,1,900,700),(10,3,430,550);
...
INSERT INTO `status` VALUES (1,'not accepted'),(2,'not accepted'),(3,'not accepted'),(4,'not accepted'),(5,'not accepted'),(6,'not accepted'),(7,'not accepted'),(8,'not accepted'),(9,'not accepted'),(10,'not accepted');
...
INSERT INTO `user` VALUES (1,'robin@gotham.com','batman','Robin Johnson',55555555,'customer'),(2,'joker@gotham.com','haha','Jokester',77777777,'employee'),(3,'alyx@halflife.io','test123','Julius Alexander',5551234523,'customer');
...
-- Dump completed on 2021-05-24 11:18:02
